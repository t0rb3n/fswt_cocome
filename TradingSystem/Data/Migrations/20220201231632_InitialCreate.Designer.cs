...
namespace Data.Migrations
{
    ...
    [Migration("20220201231632_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Enterprise.Enterprise", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Data.Enterprise.Product", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Data.Enterprise.ProductSupplier", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Data.Store.OrderEntry", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Data.Store.ProductOrder", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Data.Store.StockItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Data.Store.Store", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Data.Enterprise.Product", b =>
                {
                    b.HasOne("Data.Enterprise.ProductSupplier", "ProductSupplier")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Data.Enterprise.ProductSupplier", b =>
                {
                    b.HasOne("Data.Enterprise.Enterprise", null)
            ...
            modelBuilder.Entity("Data.Store.OrderEntry", b =>
                {
                    b.HasOne("Data.Enterprise.Product", "Product")
                        .WithMany()
                    ...
                    b.HasOne("Data.Store.ProductOrder", "ProductOrder")
            ...
            modelBuilder.Entity("Data.Store.ProductOrder", b =>
                {
                    b.HasOne("Data.Store.Store", "Store")
            ...
            modelBuilder.Entity("Data.Store.Store", b =>
                {
                    b.HasOne("Data.Enterprise.Enterprise", "Enterprise")
                        .WithMany("Stores")
                        .HasForeignKey("EnterpriseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
