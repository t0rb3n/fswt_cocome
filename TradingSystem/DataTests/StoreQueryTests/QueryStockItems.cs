...
public class QueryStockItems
{
    private readonly DatabaseFixture _fixture;
    private readonly IStoreQuery _storeQuery;

    public QueryStockItems(DatabaseFixture fixture)
    {
        _fixture = fixture;
    ...
    public void Found_StockItems()
    {
        ...
        var result = _storeQuery.QueryStockItems(storeId, productIds, _fixture.Context);
    ...
    public void Found_No_StockItems_Product_List()
    {
        const long storeId = 1;
        long[] productIds = { 1,-2,3 };
        var action = () => _storeQuery.QueryStockItems(storeId, productIds, _fixture.Context);
