...
using CashDesk.Domain.Entities;
...
/// </summary>
public class CashDeskCoordinator: ICoordinatorEvents
{
    public event System.EventHandler? EnableExpressMode;
    ...
    /// <summary> This constructor initializes the logger and the Cashdesk
