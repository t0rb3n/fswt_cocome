...
CREATE TABLE stores (
    ...
    CONSTRAINT fk_stores_enterprises_enterprise_id FOREIGN KEY (enterprise_id) REFERENCES enterprises (id) ON DELETE CASCADE
);
...
VALUES ('20220126211830_InitialCreate', '6.0.1');
